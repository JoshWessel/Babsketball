...
public:
	...
	int playGame(int timeLimit, int overtimeLimit, bool isASeries, int gameNumberInSeries, int gamesInSeries)
	{
		...
		//displayMatchups(babMan.team1, babMan.team2);
	...
	void printTeamAttributes(Team& t, Babdul& bc, Babdul& defender)
	{
		...
		cout << "Babname Position Overall Tier       Build         Babdulishness S-Close S-Mid S-3 PSAC Off-Reb Speed Strength Points Blocks Assists Turnovers" << endl;
		cout << "=============================================================================================================================================" << endl;
		for (int i = 0; i < t.getNumPlayers(); i++)
		{
	...
	void printDefenderAtttributes(Babdul defender)
	{
		...
		cout << "Babname Position Overall Tier       Build         Babdulishness Per-D Int-D S-Contest Block Def-Reb Points Blocks Assists Turnovers" << endl;
		cout << "===================================================================================================================================" << endl;
	...
	void possession(Team& team1, Team& team2, int currTeamNum, bool AIPossession)
	{
		...
		while (!changePossession && time < gameLength)
		{
			...
			printCourt(team1);
			printTeamAttributes(team1, BC, DF);
	...
	void findRebounder(Team& offensiveReboundingTeam, Team& defensiveReboundingTeam)
	{
		...
		if (numOffensiveRebounders > 0)
		{
			...
			if (offensiveReboundingTeam.players.at(randOR).getOffRebound() > defensiveReboundingTeam.players.at(randDR).getDefRebound() && variation == 0)
			{
	...
	void adjustMatchupsMenu(Team& team1, Team& team2)
	{
		...
		while (teamSelect != 0)
		{
			...
			cout << "(0) Exit" << endl;
			cout << "(1) " << team1.getTeamName() << endl;
			cout << "(2) " << team2.getTeamName() << endl;
			cout << endl;
	...
	{
		// Default matchups, based on height
		team1.players = babMan.sortBy(team1.players, "height");
		team2.players = babMan.sortBy(team2.players, "height");
