...
public:
	...
	bool shoot(Babdul& defender, int numPasses, int numDrives)
	{
		...
		newSkill -= ((defender.getShotContest() * defender.sliders.slider_shotContest) / 7);
	...
	bool attemptBlock()
	{
		...
		if (success > (BABDULISHNESS * sliders.slider_babdulishness) && success < ((BLOCK * sliders.slider_block) - 25))
		{
			return true;
		}
		else
	...
	bool attemptDefRebound()
	{
		...
		if (success > (BABDULISHNESS * sliders.slider_babdulishness) && success < ((DEF_REB * sliders.slider_defRebound) - 25))
		{
			return true;
		}
		else
	...
	bool attemptOffRebound()
	{
		...
		if (success > (BABDULISHNESS * sliders.slider_babdulishness) && success < ((OFF_REB * sliders.slider_offRebound) - 25))
		{
			return true;
		}
		else
